...
# DNS PATCH
#tipeos2=$(uname -m)
#Name=$(curl -sS https://raw.githubusercontent.com/Microtech001/anjim1/main/anjayy/allow | grep $MYIP | awk '{print $2}')
#Exp=$(curl -sS https://raw.githubusercontent.com/Microtech001/anjim1/main/anjayy/allow | grep $MYIP | awk '{print $3}')
# GETTING DOMAIN NAME
